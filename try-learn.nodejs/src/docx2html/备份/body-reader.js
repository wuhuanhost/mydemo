...
function BodyReader(options) {
    ...
    function readDrawingElement(element) {
        var blips = element
		   ...
		   var extent=element.getElementsByTagName("wp:extent");
    ...
    function readBlip(element, blip) {
        ...
        var altTextx = element.first("wp:extent").attributes.cx;
		var altTexty = element.first("wp:extent").attributes.cy;
        return readImage(findBlipImageFile(blip), altText+"#"+altTextx+","+altTexty);
    }
